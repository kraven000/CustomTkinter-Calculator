...
def remove_text(events=None,remove_all=False):
    '''It is the function which remove the previous charater from entry widget if backspace key is 
    pressed or clear all the charaters from the entry widget if 'CE' button is clicked.'''
...
if __name__=="__main__":
    ...
    button_equal = ct.CTkButton(window,text="=",font=("Roboto",16),width=90,height=60,
                                        border_width=0,command=evaluate_expression)
